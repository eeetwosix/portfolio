            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <textarea maxlength="200" class="form-control rounded-0 border-warning" style="resize:none;" id="toMessage" rows="4" aria-describedby="projectTitle" placeholder="Project Title" required></textarea>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <textarea maxlength="250" class="form-control rounded-0 border-warning" style="resize:none;" id="toMessage" rows="4" aria-describedby="projDescription" placeholder="Project Description" required></textarea>
                        <small id="textAreaDesc" class="form-text text-light">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <input maxlength="205" type="text" class="form-control rounded-0 border-warning" id="toGithubLink" placeholder="Github Link" aria-describedby="githubLink" required>
                    </div>
                    <div class="form-group col-sm-12">
                        {{-- <label for="toGithubLink" class="text-warning">Email Address</label> --}}
                        <input maxlength="200" type="text" class="form-control rounded-0 border-warning" id="toLivePreviewLink" placeholder="Live Preview Link" aria-describedby="livePreviewLink" required>
                    </div>
                    <div class="form-group col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control border border-warning rounded-0 text-center" id="toProjectCategory" required>
