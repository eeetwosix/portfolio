...
<div class="jumbotron jumbotron-fluid bg-dark text-center">
  <div class="container">
      <h2 class="display-4 text-warning" style="margin-top:-2rem;">Interested in working with me?</h2>
      ...
      <div class="container pb-2">
        <div class="card rounded-0 bg-warning">
          ...
          <div class="card-body bg-light">
            <p class="text-uppercase font-weight-bolder text-center">{{$project->project_title}}</p>
            <p class="font-weight-light">{{$project->project_description}}</p>
            <div class="card-body row"  style="margin-bottom:-1rem">
              ...
              <div class="col container pb-1">
                <a class="rounded-0 border border-dark btn btn-warning btn-lg text-dark col-sm-12 font-weight-bolder" href="{{$project->live_preview_link}}" role="button">LIVE PREVIEW
                    <i class="material-icons align-middle">
                        cloud
                    </i>
                  </a>
